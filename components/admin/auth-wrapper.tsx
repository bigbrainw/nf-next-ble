  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-950">
        ...
        <div className="text-center text-sm text-gray-500 mt-4">Create new admin account: <Link href="mailto:inky@enk.icu" className="text-blue-500 hover:underline">inky@enk.icu</Link></div>
      </div>
    );
  }
